...
`pnpm dev` で起動したセットアップ画面には「ローカル検証ツール」が表示されます。1対0の投手戦、乱打戦、満塁サヨナラ、延長戦、DHでの投手交代、代走・盗塁・代打、フォース第3アウト、小技・特殊プレーの8パターンを選んで各画面と集計を確認できます。このツールとサンプル選手のプリセットは開発環境専用で、`pnpm build` した本番環境には表示されません。
